...
**YOU ARE IN: `ideadock/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/ideadock/` (rig root) or other directories
...
**Your mail address:** `ideadock/polecats/rust`
**Your rig:** ideadock
**Your Witness:** `ideadock/witness`
...
```bash
gt mail send ideadock/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
